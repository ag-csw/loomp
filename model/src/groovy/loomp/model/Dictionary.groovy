...
/**
 * A dictionary stores the mapping between an external vocabulary and a annotation contained
 * in an annotation set of loomp.
 */
class Dictionary extends DomainEntity {
	@Expose static URI type = Loomp.Dictionary
