...
/**
 * A document is an ordered list of elements.
 */
class Document extends DomainEntity {
	@Expose static URI type = Loomp.Document

	/** title of the document */
	@Expose String title

	/** URIs of the elements belonging to this document */
	@Expose List<URI> elements

	public static mapping = DomainEntity.mapping + [
			title : DC.title,
			elements : Loomp.hasElements,
