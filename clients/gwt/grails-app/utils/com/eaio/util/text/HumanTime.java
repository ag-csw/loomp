 ...
 * <p>
 * Use HumanTime by creating an instance that contains the time delta ({@link com.eaio.util.text.HumanTime#HumanTime(long)}), create an
 * empty instance through ({@link com.eaio.util.text.HumanTime#HumanTime()}) and set the delta using the {@link #y()}, {@link #d()},
...
public class HumanTime implements Externalizable, Comparable<HumanTime>, Cloneable {
	...
	/**
	 * Parses a {@link CharSequence} argument and returns a {@link com.eaio.util.text.HumanTime} instance.
	 *
